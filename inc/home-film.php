...
function graffit_home_film_mobile_config(): array
{
    ...
    return [
        ...
        'p1Last' => 120,
        'p2Last' => 120,
        'poster' => $base . 'ezgif-frame-001_result-4.webp',
        'pad' => 3,
        'ext' => '_result-4.webp',
        'scrollPace' => 1,
        'phase2ScrollPace' => 1.85,
        'source' => 'mobile-ezgif-121',
        'p2FrameOffset' => 1,
        'p2Ext' => '_result-5.webp',
        'p2AltExt' => '',
        'p2AltLastFrame' => 0,
        'p2TailFrameSkip' => 0,
        'cacheKey' => 'home-film-mobile-' . substr(sha1($base . '|p1:001-121:result-4|p2:001-121:result-5|query-v1'), 0, 16),
    ];
}
